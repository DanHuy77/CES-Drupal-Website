 ...
 * @endcode
 */
$settings['hash_salt'] = '_8UfDkDL3m4KWc0FGQe2Ff9gJdpQVI-94GOIO0eciWpPGM9hXwpgss6CBvYLoT62jnrZi28_kw';
...
$production_settings = __DIR__ . "/settings.production.php";
...
if (file_exists($local_settings)) {
  ...
  } else if (file_exists($production_settings)) {
...
switch($server){
  case 'dev-ces-website.pantheonsite.io':
    $verenv = 'dev';
  break;

  case 'test-ces-website.pantheonsite.io':
    $verenv = 'staging';
  break;

  case 'codeenginestudio.com':
    $verenv = 'prod';
  break;
